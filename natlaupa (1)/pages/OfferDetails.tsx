  ...
  return (
    <div className="bg-deepBlue min-h-screen text-slate-100">
      ...
      <div className="relative h-[100dvh] w-full">
        ...
        {/* Updated Back Button Position for Mobile Safety */}
        <div className="absolute top-28 left-4 md:top-32 md:left-8 z-20">
          <Link to="/" className="flex items-center text-white/70 hover:text-gold transition-colors group">
        ...
        <div className="bg-deepBlue border-b border-white/5 relative z-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div 
                    ...
                    data-lenis-prevent // Prevents parent Lenis scroll from hijacking this horizontal scroll
